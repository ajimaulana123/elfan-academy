 ...
 const Footer = () => {
   return (
     <footer id="kontak" className="bg-emerald-dark text-primary-foreground">
       {/* Main Footer */}
         ...
         <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-10">
           ...
           <div className="lg:col-span-2">
             ...
             <p className="text-primary-foreground/70 leading-relaxed mb-6 max-w-md">
               Lembaga pendidikan Islam yang mengintegrasikan nilai-nilai keislaman 
               dengan teknologi kecerdasan buatan untuk membentuk generasi muslim 
               yang berakhlak mulia dan berdaya saing global.
             </p>
             ...
             <ul className="space-y-4">
               <li className="flex items-start gap-3">
                 ...
                 <span className="text-primary-foreground/70 text-sm">
                   Jl. Pendidikan No. 123, Kota, Indonesia 12345
                 </span>
               </li>
       ...
       <div className="border-t border-primary-foreground/10">
         <div className="container mx-auto px-4 py-6 flex flex-col md:flex-row items-center justify-between gap-4">
           <p className="text-primary-foreground/50 text-sm text-center md:text-left">
             © 2025 Elfan AI Academy. Hak Cipta Dilindungi.
           </p>
